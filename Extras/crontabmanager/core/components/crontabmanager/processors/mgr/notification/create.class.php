 ...
 * Create an Task
 */
class CronTabManagerNotificationCreateProcessor extends modObjectCreateProcessor
{
    /* @var CronTabManagerNotification $object */
    public $object = 'CronTabManagerNotification';
...
return 'CronTabManagerNotificationCreateProcessor';
