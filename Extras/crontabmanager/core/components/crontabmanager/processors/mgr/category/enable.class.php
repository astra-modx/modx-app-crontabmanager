 ...
 * Enable an Item
 */
class CronTabManagerCategoryEnableProcessor extends modObjectProcessor
{
    ...
    public $permission = 'crontabmanager_enable';
...
return 'CronTabManagerCategoryEnableProcessor';
